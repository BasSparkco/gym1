...
export default async function EditDiscountTypePage({ params }: Props) {
  ...
  async function handleUpdate(formData: FormData) {
    ...
    await updateDiscountType(discountTypeId, {
      ...
      nameHe: (formData.get("nameHe") as string).trim() || null,
        ...
        <form action={handleUpdate} className="grid gap-5">
          ...
          <div className="grid gap-1.5 sm:grid-cols-2">
            <div className="grid gap-1.5">
              ...
              <input
                ...
                name="nameAr"
                dir="rtl"
                defaultValue={discountType.nameAr ?? ""}
            ...
            <div className="grid gap-1.5">
              ...
              <input
                ...
                name="nameHe"
                dir="rtl"
                defaultValue={discountType.nameHe ?? ""}
          ...
          <div className="grid gap-1.5">
            ...
            <input
              ...
              max="100"
              step="0.01"
              defaultValue={discountType.defaultPercent}
