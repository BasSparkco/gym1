...
export default async function EmployeeCheckInPage({ searchParams }: Props) {
  ...
  return (
    <div className="grid gap-6">
      <PageHeader
        eyebrow={t.nav.employeeCheckIn}
        title={t.attendance.checkInTitle}
        description={t.attendance.checkInDescription}
      />
